/**
 * Component: SellerAnalyticsOverlay
 * Hiển thị Màn hình 24 – Thống kê hiệu suất dưới dạng Overlay trượt từ phải
 */
        ...
        {data.map((d, i) => {
          ...
          return (
            <View key={i} style={barStyles.barCol}>
              {isHighest && <Text style={barStyles.barTopLabel}>{d.value}</Text>}
              <View style={barStyles.barTrack} pointerEvents="none">
                <View style={[barStyles.bar, { height: heightPct, backgroundColor: isHighest ? PRIMARY : '#BFDBFE' }]} />
              </View>
...
const barStyles = StyleSheet.create({
  ...
  yAxis: { width: 36, height: 120, justifyContent: 'space-between', alignItems: 'flex-end', paddingBottom: 18 },
  yLabel: { fontSize: 9, color: GRAY_400, fontWeight: '500' },
  barsWrap: { flex: 1, flexDirection: 'row', alignItems: 'flex-end', gap: 6 },
  barCol: { flex: 1, alignItems: 'center', gap: 4 },
  barTrack: { width: '100%', height: 120, justifyContent: 'flex-end', backgroundColor: GRAY_100, borderRadius: 6 },
...
export function SellerAnalyticsOverlay({ visible, onClose, onOpenVip }: Props) {
      ...
      >
              ...
              <View key={item.rank} style={styles.topItem}>
                ...
                <View style={styles.topInfo}>
                  ...
                  <View style={styles.topMeta}>
                    <Text style={styles.topMetaText}>👁️ {item.views} xem</Text>
        ...
        <View style={styles.tipCard}>
          ...
          <Text style={styles.tipText}>
            Tin đăng "Vinhomes Grand Park" đang có lượt xem tốt.
            Nâng cấp VIP để tăng gấp 3 lần lượt tiếp cận!
          </Text>
          <TouchableOpacity
            style={styles.tipBtn}
            onPress={onOpenVip}
...
const styles = StyleSheet.create({
  ...
  periodRow: { flexDirection: 'row', gap: 8, paddingHorizontal: 16, paddingBottom: 10, justifyContent: 'center' },
  periodBtn: { flex: 1, paddingVertical: 8, borderRadius: 10, backgroundColor: GRAY_100, alignItems: 'center' },
  ...
  rankText: { fontSize: 11, fontWeight: '900', color: GRAY_800 },
  topImg: {
    width: 44, height: 44, borderRadius: 10, alignItems: 'center', justifyContent: 'center', flexShrink: 0,
  },
  ...
  tipCard: { backgroundColor: '#EFF6FF', borderRadius: 16, padding: 16, gap: 8, borderWidth: 1, borderColor: '#BFDBFE' },
  tipTitle: { fontSize: 14, fontWeight: '800', color: PRIMARY },
  tipText: { fontSize: 13, color: '#1E40AF', lineHeight: 19 },
  tipBtn: { backgroundColor: PRIMARY, borderRadius: 10, paddingVertical: 10, alignItems: 'center', marginTop: 4 },
